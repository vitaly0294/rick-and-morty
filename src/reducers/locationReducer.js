...
export const setPageLocation = (payload) => ({ type: SET_PAGE_LOCATION, payload });
export const setLinkPageIdArrCharacters = (payload) => ({ type: SET_LINK_PAGE_ARR_LOCATION, payload });
export const setCharactersListInLocation = (payload) => ({ type: SET_CHARACTERS_LIST_IN_LOCATION, payload });
export const setErrorLocationEpisode = (payload) => ({ type: SET_ERROR_LOCATION_LOCATION, payload });
export const setErrorLocationCharacters = (payload) => ({ type: SET_ERROR_LOCATION_CHARACTERS, payload });
